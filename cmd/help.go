...
Files:
	gokeybr stores log of your training sessions in file ~/.local/state/gokeybr/sessions_log.jsonl.
	...
	~/.local/state/gokeybr/stats.json is used to store general statistics used to generate training sessions.
`
